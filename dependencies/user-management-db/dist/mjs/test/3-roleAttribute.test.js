...
beforeAll(async () => {
    ...
    const roleAttribute = new RoleAttributeService(pool);
    await roleAttribute.truncate();
    console.log("Starting truncate Role table...");
    const role = new RoleService(pool);
    await role.truncate();
});
afterAll(async () => {
    await pool.end();
...
describe("Role Service", () => {
    ...
    it("it should select all role attribute", async () => {
        const roleService = new RoleAttributeService(pool);
    ...
    it("it should delete a role by id", async () => {
        ...
        const roleAttributeService2 = new RoleAttributeService(pool);
